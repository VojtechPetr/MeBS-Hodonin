  ...
  links: [
    ...
    },
    {
      ...
      links: [
        ...
        // },
        {
          text: 'Oznámení o přerušení  dodávky el. energie 20.5.2025',
          href: getPermalink('oznameni-odstavka205', 'post'),
        },
        {
          text: 'Oznámení o přerušení  dodávky el. energie 21.5.2025',
          href: getPermalink('oznameni-odstavka215', 'post'),
        },
        {
