...
import type { ContentData, KontaktyData, CenikData, AkceData, TeploData, SVJKontaktyData } from '~/types';

type AvailableDataTypes = ContentData | KontaktyData | CenikData | AkceData | TeploData | SVJKontaktyData;
